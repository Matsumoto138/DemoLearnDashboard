...
function UpcomingCoursesComponent({ data }) {
  if (!data || !Array.isArray(data.upcoming_courses)) {
    return <p>No upcoming courses data available.</p>;
  }
...
export default UpcomingCoursesComponent;
